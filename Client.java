...
public class Client extends UnicastRemoteObject implements ChatInterface, Runnable {
    ...
    public boolean checkClientCredintials(ChatInterface chatinterface, String clientname)
    ...
    public static void main(String[] args) throws MalformedURLException, RemoteException, NotBoundException {
        ...
        ChatInterface chatinterface = (ChatInterface) Naming.lookup("rmi://127.0.0.1/RMIServer");
